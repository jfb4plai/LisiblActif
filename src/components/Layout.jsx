  ...
  return (
    <div>
      <nav className="plai-nav">
        <Link to="/dashboard" className="plai-nav-logo">
          <LogoPlai size="sm" />
          LisiblActif
        </Link>
        <div className="plai-nav-actions">
          <Link to="/dashboard" className="plai-nav-link">Analyser</Link>
      ...
      <footer className="plai-footer">
        <p>LisiblActif — PLAI, Pôle Liégeois d'Accompagnement vers une École Inclusive</p>
      </footer>
    </div>
  )
}
